package com.creolophus.common.id;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * copy from https://github.com/beyondfengyu/SnowFlake/blob/master/SnowFlake.java 朝辞白帝彩云间 千行代码一日还
 * 两岸领导啼不住 地铁已到回龙观
 *
 * @author magicnana
...
public final class OriginalSnowflakeID {
  ...
  public OriginalSnowflakeID() {
    this(
        (MachineInfo.getMachineIdentifier() + MachineInfo.getProcessIdentifier() + "").hashCode()
            & MAX_DATACENTER_NUM,
